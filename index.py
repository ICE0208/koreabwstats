...
avail_server_list = [470135923829637120,735559615130894436,723458435143827568,862893539846389780,878136909224886283]
    ...
    while not client.is_closed():  
        try:
            ...
            for player_list in player_lists:
                ...
                elif (player_name == "Icetain"): player_name = "Icetain <풍이>"
